          ...
          terms: {
            ...
            items: {
              ...
              properties: {
                ...
                clinicalTerm: { type: "string", description: "The SNOMED CT PREFERRED TERM for this concept, IN ENGLISH — the single canonical English concept name, NOT a literal word-for-word translation. When the text is not English, name the concept as SNOMED CT would (e.g. 'inflamación pancreática' -> 'pancreatitis' (NOT 'pancreatic inflammation'); 'nódulo tiroideo' -> 'thyroid nodule'; 'secreción uretral' -> 'urethral discharge'; 'insuffisance cardiaque' -> 'heart failure'; 'fiebre' -> 'fever'). Map lay/descriptive phrasing to formal terminology and correct spelling (e.g. 'low platelet count' -> 'thrombocytopenia'). ALWAYS give the POSITIVE concept even when the text is negated — the negation is captured separately in context (e.g. 'no fever' -> 'fever'). If the text is already the standard English clinical term, repeat it unchanged." },
